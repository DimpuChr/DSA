...
public class CustomLL {
    ...
    public Node mergeTwoSortedListNode(Node list1 , Node list2){
       ...
       /* if (a == null)
        ...
        if (a.value <= b.value) {
            result = a;
            result.next = mergeTwoSortedListNode(a.next, b);
        } else {
            result = b;
            result.next = mergeTwoSortedListNode(a, b.next);
        }
        return result;
*/
    }
    ...
    public Node mergeTwoLists(CustomLL cl1, CustomLL cl2){
        return mergeTwoLists(cl1.head,cl2.head);
    }
